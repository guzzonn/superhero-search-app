...
// API Key => 111352825142591

const fetchAllSuperHero = async (searchText) => {
  let url = `https://superheroapi.com/api.php/111352825142591/search/${searchText}`;
  try {
...
const showSuperheroDetails = (data) => {
  ...
  document.querySelector(".biography").innerHTML = `
    <li><span>full name</span><span>${data[0].biography["full-name"]}</span></li>
    <li><span>alert-egos</span><span>${data[0].biography["alter-egos"]}</span></li>
    <li><span>aliases</span><span>${data[0].biography["aliases"]}</span></li>
    <li><span>place-of-birth</span><span>${data[0].biography["place-of-birth"]}</span></li>
    <li><span>first-appearance</span><span>${data[0].biography["first-appearance"]}</span></li>
    <li><span>publisher</span><span>${data[0].biography["publisher"]}</span></li>
  `;
